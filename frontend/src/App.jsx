            ...
            <div className="footer-column">
              <div className="footer-social-wrapper">
                ...
                <div className="footer-socials">
                  <a href="https://www.linkedin.com/in/moilla-hemantheswar-reddy-549373247/" aria-label="LinkedIn" className="social-icon social-linkedin" target="_blank" rel="noopener noreferrer">
