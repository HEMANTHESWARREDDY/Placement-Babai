            ...
            <header className="header mentor-dashboard-header">
                <div className="header-content">
                    <div className="logo" style={{cursor: 'default'}}>
                        ...
                        <span className="mentor-nav-tagline">Mentor Dashboard</span>
                    </div>
                    ...
                    <nav className={isMobileMenuOpen ? "nav-open" : ""}>
                        <ul className="nav-links">
                            <li>
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginRight: '8px' }}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    Profile
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                style={{ display: 'flex', alignItems: 'center' }}
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginRight: '8px' }}><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                                    Analytics
                                </a>
                            </li>
                            <li className="logout-li">
                                <button className="admin-nav-btn" onClick={onLogout} style={{ width: '100%', background: '#ef4444', justifyContent: 'center', display: 'flex', alignItems: 'center' }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginRight: '8px' }}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                                    Logout
                                </button>
                            </li>
                        </ul>
                ...
                {(!showBookings && !isEditingProfile && !showAnalytics) && (
                    ...
                    <div className="mentor-welcome-wrap">
                        <div className="welcome-text-new">
                            <div className="welcome-username-row">
                                Welcome back! 👋 {profile?.username || mentorAuth?.username}
                            </div>
                            <div className="welcome-tag-row">
                                <span className="mentor-role-badge">@Mentor</span>
                            </div>
                        </div>
                        <button 
                    ...
                    <div className="mentor-edit-actions-bar">
                        ...
                        <div className="mentor-edit-actions-right" style={{ marginLeft: '10px' }}>
                            <button 
                                ...
                                title="View Preview"
                            >
                                <span className="m-icon">👁️</span> <span className="m-text">Preview</span>
                            </button>
                                ...
                                <div className="preview-top-row" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', width: '100%', marginBottom: '1rem' }}>
                                    ...
                                    <div className="preview-header-meta" style={{ 
                                        ...
                                        <div className="preview-socials" style={{ gap: '6px', display: 'flex', alignItems: 'center' }}>
                                            ...
                                            {profile.linkedin && (
                                                <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="preview-social-icon-raw" title="LinkedIn" style={{ background: 'none', border: 'none', boxShadow: 'none', width: 'auto', height: 'auto', padding: 0 }}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="30" height="30" style={{ display: 'block' }}>
                                                        <defs>
                                                            <filter id="shadow-li-db1" x="-15%" y="-15%" width="130%" height="130%">
                                                                <feDropShadow dx="0" dy="1.5" stdDeviation="2" flood-opacity="0.15"/>
                                                            </filter>
                                                        </defs>
                                                        <circle cx="24" cy="24" r="22" fill="#0a66c2" filter="url(#shadow-li-db1)"/>
                    ...
                    <div className="preview-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="preview-body">
                                    ...
                                    <div className="preview-socials" style={{ gap: '6px', display: 'flex', alignItems: 'center' }}>
                                        ...
                                        {profile.linkedin && (
                                            <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="preview-social-icon-raw" title="LinkedIn" style={{ background: 'none', border: 'none', boxShadow: 'none', width: 'auto', height: 'auto', padding: 0 }}>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="30" height="30" style={{ display: 'block' }}>
                                                    <defs>
                                                        <filter id="shadow-li-db2" x="-15%" y="-15%" width="130%" height="130%">
                                                            <feDropShadow dx="0" dy="1.5" stdDeviation="2" flood-opacity="0.15"/>
                                                        </filter>
                                                    </defs>
                                                    <circle cx="24" cy="24" r="22" fill="#0a66c2" filter="url(#shadow-li-db2)"/>
                                                    <path fill="#FFF" d="M12 19h5v17h-5V19zm2.5-7a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zm5.5 7h5v2.5c1-2 3.5-3.5 6-3.5 6 0 7 4 7 9V36h-5v-8.5c0-3-1.5-4.5-3.5-4.5-2 0-3.5 1.5-3.5 4.5V36h-5V19z"/>
                                                </svg>
                                            </a>
                                        )}
                            ...
                            <div className="preview-title-row" style={{marginBottom: '0.2rem'}}>
                                ...
                                <div className="preview-badges">
                                <div className="preview-badge" style={{background: 'white', border: '1px solid #e2e8f0', color: '#64748b', boxShadow: '0 1px 2px rgba(0,0,0,0.05)'}}>💼 {profile.experience ? (profile.experience.toLowerCase().includes('year') ? profile.experience : `${profile.experience} ${parseInt(profile.experience, 10) === 1 ? 'Year' : 'Years'} of experience`) : '4 Years of experience'}</div>
                                </div>
