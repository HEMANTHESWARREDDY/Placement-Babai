        ...
        <div className="ph-container">
            ...
            <div className="ph-workspace">
                        ...
                        <div className="ph-play-zone">
                            <div className="ph-play-header">
                                <div className="ph-play-title-wrap">
                                    ...
                                    <h2>Bug Hunter - Question {gameState.currentQuestionIndex + 1} of {BUG_HUNTER_QUESTIONS.length}</h2>
                                </div>
                                <button className="ph-btn-back" onClick={backToMenu}>✕ Quit Game</button>
                            </div>
                            ...
                            {gameState.showResults ? (
                                ...
                                <>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                        ...
                                        <span style={{ color: gameState.timerLeft <= 8 ? 'var(--ph-danger)' : 'var(--ph-accent)', fontWeight: '800' }}>
                                            ⏱️ {gameState.timerLeft}s
                                        </span>
                                    </div>

                                    <div className="ph-timer-bar-container">
                                        <div 
                                    ...
                                    {gameState.isAnswered && (
                                        <div style={{ margin: '1.5rem 0', padding: '1rem', background: '#f8fafc', borderRadius: '12px', borderLeft: '4px solid var(--ph-primary)' }}>
                                    ...
                                    <div className="ph-action-footer">
                                        <div />
                                        {gameState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextQuestion('bug-hunter')}>
                                                {gameState.currentQuestionIndex + 1 === BUG_HUNTER_QUESTIONS.length ? "Finish Workout" : "Next Code Snippet →"}
                                            </button>
                                        )}
                                    </div>
                                </>
                    ...
                    {activeGame === 'output-predictor' && (
                        <div className="ph-play-zone">
                            <div className="ph-play-header">
                                <div className="ph-play-title-wrap">
                                    <span className="ph-play-icon">🔮</span>
                                    <h2>Output Predictor - Question {gameState.currentQuestionIndex + 1} of {OUTPUT_PREDICTOR_QUESTIONS.length}</h2>
                                </div>
                                <button className="ph-btn-back" onClick={backToMenu}>✕ Quit Game</button>
                            </div>
                            ...
                            {gameState.showResults ? (
                                ...
                                <>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                        <span style={{ fontWeight: '600' }}>Predict the output of the following block:</span>
                                        <span style={{ color: gameState.timerLeft <= 6 ? 'var(--ph-danger)' : 'var(--ph-accent)', fontWeight: '800' }}>
                                            ⏱️ {gameState.timerLeft}s
                                        </span>
                                    </div>
                                    ...
                                    <div className="ph-action-footer">
                                        <div />
                                        {gameState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextQuestion('output-predictor')}>
                                                {gameState.currentQuestionIndex + 1 === OUTPUT_PREDICTOR_QUESTIONS.length ? "Finish Workout" : "Next Code Snippet →"}
                                            </button>
                                        )}
                                    </div>
                                </>
                    ...
                    {activeGame === 'code-sprint' && (
                        <div className="ph-play-zone">
                            <div className="ph-play-header">
                                <div className="ph-play-title-wrap">
                                    <span className="ph-play-icon">⚡</span>
                                    <h2>Code Sprint - Question {gameState.currentQuestionIndex + 1} of {CODE_SPRINT_QUESTIONS.length}</h2>
                                </div>
                                <button className="ph-btn-back" onClick={backToMenu}>✕ Quit Game</button>
                            </div>
                            ...
                            {gameState.showResults ? (
                                ...
                                <>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                        <span style={{ fontWeight: '700' }}>Task: {CODE_SPRINT_QUESTIONS[gameState.currentQuestionIndex].title}</span>
                                        <span style={{ color: gameState.timerLeft <= 5 ? 'var(--ph-danger)' : 'var(--ph-accent)', fontWeight: '800' }}>
                                            ⏱️ {gameState.timerLeft}s remaining
                                        </span>
                                    </div>
                                    ...
                                    <div className="ph-action-footer">
                                        <div />
                                        {gameState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextQuestion('code-sprint')}>
                                                {gameState.currentQuestionIndex + 1 === CODE_SPRINT_QUESTIONS.length ? "Finish Sprint" : "Next Sprint Question →"}
                                            </button>
                                        )}
                                    </div>
                                </>
                        ...
                        <div className="ph-play-zone">
                            <div className="ph-play-header">
                                <div className="ph-play-title-wrap">
                                    ...
                                    <h2>SQL Detective - Question {gameState.currentQuestionIndex + 1} of {SQL_DETECTIVE_QUESTIONS.length}</h2>
                                </div>
                                <button className="ph-btn-back" onClick={backToMenu}>✕ Quit Game</button>
                            </div>
                            ...
                            {gameState.showResults ? (
                                ...
                                <>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                        <span style={{ fontWeight: '700' }}>SQL Schema Case:</span>
                                        <span style={{ color: gameState.timerLeft <= 8 ? 'var(--ph-danger)' : 'var(--ph-accent)', fontWeight: '800' }}>
                                            ⏱️ {gameState.timerLeft}s
                                        </span>
                                    </div>
                                    ...
                                    <div className="ph-action-footer">
                                        <div />
                                        {gameState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextQuestion('sql-detective')}>
                                                {gameState.currentQuestionIndex + 1 === SQL_DETECTIVE_QUESTIONS.length ? "Submit Case" : "Next SQL Case →"}
                                            </button>
                                        )}
                                    </div>
                                </>
                    ...
                    {activeGame === 'error-fix' && (
                        <div className="ph-play-zone">
                            <div className="ph-play-header">
                                <div className="ph-play-title-wrap">
                                    <span className="ph-play-icon">🛠️</span>
                                    <h2>Error Fix Challenge - Question {gameState.currentQuestionIndex + 1} of {ERROR_FIX_QUESTIONS.length}</h2>
                                </div>
                                <button className="ph-btn-back" onClick={backToMenu}>✕ Quit Game</button>
                            </div>
                            ...
                            {gameState.showResults ? (
                                ...
                                <>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                        <span style={{ fontWeight: '600' }}>{ERROR_FIX_QUESTIONS[gameState.currentQuestionIndex].description}</span>
                                        <span style={{ color: gameState.timerLeft <= 7 ? 'var(--ph-danger)' : 'var(--ph-accent)', fontWeight: '800' }}>
                                            ⏱️ {gameState.timerLeft}s
                                        </span>
                                    </div>
                                    ...
                                    <div className="ph-action-footer">
                                        <div />
                                        {gameState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextQuestion('error-fix')}>
                                                {gameState.currentQuestionIndex + 1 === ERROR_FIX_QUESTIONS.length ? "Finish Workout" : "Next Error Case →"}
                                            </button>
                                        )}
                                    </div>
                                </>
                    ...
                    {activeGame === 'daily-quiz' && (
                        <div className="ph-play-zone">
                            <div className="ph-play-header">
                                <div className="ph-play-title-wrap">
                                    <span className="ph-play-icon">🧠</span>
                                    <h2>Daily Quiz - Question {gameState.currentQuestionIndex + 1} of {MCQ_QUESTIONS[mcqTopic].length}</h2>
                                </div>
                                <button className="ph-btn-back" onClick={backToMenu}>✕ Quit Quiz</button>
                            </div>
                            ...
                            {gameState.showResults ? (
                                ...
                                <>
                                    ...
                                    {/* Timer display */}
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                        <span style={{ fontWeight: '700' }}>Challenge Arena:</span>
                                        <span style={{ color: gameState.timerLeft <= 6 ? 'var(--ph-danger)' : 'var(--ph-accent)', fontWeight: '800' }}>
                                            ⏱️ {gameState.timerLeft}s remaining
                                        </span>
                                    </div>
                                    ...
                                    <div className="ph-action-footer">
                                        <div />
                                        {gameState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextQuestion('daily-quiz')}>
                                                {gameState.currentQuestionIndex + 1 === MCQ_QUESTIONS[mcqTopic].length ? "Finish Workout" : "Next Question →"}
                                            </button>
                                        )}
                                    </div>
                                </>
                    ...
                    {activeTab === 'mcq-battle' && mcqMode === 'battle' && (
                        <div className="ph-play-zone" style={{ background: '#0f172a', border: '1px solid #1e293b' }}>
                            <div className="ph-play-header" style={{ borderBottom: '1px solid #1e293b' }}>
                                ...
                                <button className="ph-btn-back" style={{ background: '#1e293b', color: '#ffffff' }} onClick={backToMenu}>✕ Flee Battle</button>
                            </div>
                                ...
                                <>
                                    ...
                                    <div className="ph-action-footer">
                                        ...
                                        {battleState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextBattleQuestion(MCQ_QUESTIONS[mcqTopic])}>
                                                Next Attack Round →
                                            </button>
                                        )}
                                    </div>
                    ...
                    {activeGame === 'company-quiz' && (
                        <div className="ph-play-zone">
                            <div className="ph-play-header">
                                ...
                                <button className="ph-btn-back" onClick={backToMenu}>✕ Quit Workout</button>
                            </div>
                            ...
                            {gameState.showResults ? (
                                ...
                                <>
                                    ...
                                    {/* Timer display */}
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                        <span style={{ fontWeight: '700' }}>Corporate Test:</span>
                                        <span style={{ color: gameState.timerLeft <= 6 ? 'var(--ph-danger)' : 'var(--ph-accent)', fontWeight: '800' }}>
                                            ⏱️ {gameState.timerLeft}s remaining
                                        </span>
                                    </div>
                                    ...
                                    <div className="ph-action-footer">
                                        <div />
                                        {gameState.isAnswered && (
                                            <button className="ph-btn-primary" onClick={() => nextQuestion('company-quiz')}>
                                                {gameState.currentQuestionIndex + 1 === MCQ_QUESTIONS[mcqCompany].length ? "Finish Workout" : "Next Question →"}
                                            </button>
                                        )}
                                    </div>
                                </>
                ...
                <div className="ph-sidebar">
                    ...
                    {/* Streak Info Widget */}
                    <div className="ph-sidebar-section" style={{ background: 'linear-gradient(to bottom, #fffbeb, #fff7ed)' }}>
                        <h3 style={{ borderBottom: '1px solid #fed7aa' }}>🔥 Streak Rewards</h3>
                        <p style={{ fontSize: '0.9rem', color: '#c2410c', margin: '0 0 0.75rem 0', fontWeight: '700' }}>
                            Keep practicing daily to secure double multipliers on all daily challenges!
                        </p>
                            ...
                            {[1, 2, 3, 4, 5, 6, 7].map(day => (
                                <div 
                                    ...
                                    style={{
                                        ...
                                        height: '32px',
                                        borderRadius: '50%',
                                        background: day <= streak ? 'var(--ph-accent)' : '#ea580c20',
                                        color: day <= streak ? '#ffffff' : '#ea580c80',
                                        display: 'flex',
                                        alignItems: 'center',
                                        justifyContent: 'center',
                                        fontSize: '0.75rem',
                                    ...
                                    title={day <= streak ? "Streak check-in secured!" : "Lock status"}
                                >
                                    {day}
                                </div>
                            ))}
